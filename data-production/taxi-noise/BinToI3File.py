...
parser.add_argument("input", nargs='+', help="Name of .bin file to convert")
...
for input_tgz in args.input:
    # input_tgz = args.input
    output_directory="/mnt/ceph1-npx/user/dkullgren/WaveformML-DataOnly/data-production/taxi-noise/data/AugerBackground/i3Files"
    ...
    print(f"input_bin = {input_bin}")
    print(f"output_i3 = {output_i3}")
